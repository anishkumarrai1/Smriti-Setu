...
export const AiVoiceCompanion: React.FC<AiVoiceCompanionProps> = ({
  ...
  return (
    <>
        ...
        <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-2 animate-fadeIn">
          <div className="bg-white/95 backdrop-blur-md px-3.5 py-1.5 rounded-full shadow-lg border border-amber-300 text-xs font-bold text-slate-800 flex items-center gap-2">
            ...
            <span className="flex items-center gap-1 font-black text-blue-900">
              ...
              {chatLanguage === 'hi' ? 'स्मृति साथी (AI)' : 'Smriti AI'}
            </span>
          </div>
          ...
          >
            ...
            <div className="absolute -top-1 -right-1 bg-amber-400 text-[#004085] text-[10px] font-black px-2 py-0.5 rounded-full shadow-sm flex items-center gap-0.5">
              <span>✨</span>
              <span>AI</span>
            </div>
          </button>
      ...
      {isOpen && (
        <div className="fixed bottom-4 right-4 z-50 w-[94vw] sm:w-[470px] max-h-[85vh] h-[670px] bg-white rounded-3xl shadow-2xl border-2 border-slate-300 flex flex-col overflow-hidden animate-slideUp">
          
          {/* Header */}
          <div className="bg-gradient-to-r from-[#004085] via-blue-900 to-[#07243C] text-white p-3.5 flex items-center justify-between shadow-md">
